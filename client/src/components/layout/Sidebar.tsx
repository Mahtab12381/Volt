...
export function Sidebar() {
  ...
  return (
    <>
      <header className="flex shrink-0 items-center justify-between border-b border-border-hairline bg-surface-card px-4 py-3 lg:hidden">
        ...
        <button
          ...
          className="rounded-lg p-2 text-ink-secondary hover:bg-[var(--surface-hover)] hover:text-ink-primary"
      ...
      <aside
        className={clsx(
          'fixed inset-y-0 left-0 z-50 flex h-full w-64 shrink-0 -translate-x-full flex-col border-r border-border-hairline bg-surface-card px-4 py-6 transition-transform duration-200 ease-out',
      ...
      >
        <div className="mb-8 flex items-center justify-between px-2">
          ...
          <button
            type="button"
            onClick={() => setOpen(false)}
            className="rounded-lg p-1 text-ink-muted hover:text-ink-primary lg:hidden"
